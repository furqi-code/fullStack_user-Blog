                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <article className="group cursor-pointer">
                      ...
                      <p className="text-gray-600 line-clamp-2">
                        It begins to notice that there was a sharp contrast
                        between well-made designs and how they impacted the
                        overall user experience. The journey to perfection in
                        product design is not just about aesthetics.
                      </p>
                    </article>
                    ...
                    <article className="group cursor-pointer">
                      ...
                      <p className="text-gray-600 line-clamp-2">
                        Starting a business with your spouse or significant
                        other is an exciting but challenging venture. Here's
                        what you need to know about making it work.
                      </p>
                    </article>
                    ...
                    <article className="group cursor-pointer">
                      ...
                      <p className="text-gray-600 line-clamp-2">
                        Eating more plants and less meat has been tied to a
                        longer life and a reduced risk of cardiovascular disease
                        in a new study. Learn more about the benefits.
                      </p>
                    </article>
                  </div>
                </div>
